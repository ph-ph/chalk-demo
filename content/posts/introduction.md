---
title: "Introduction"
date: 2022-04-26T12:58:43-07:00
draft: false
---

Chalk is a port of [Nielsen Ramon's Jekyll theme](https://github.com/nielsenramon/chalk) to [Hugo](https://gohugo.io) . <!--more-->

You can download the source code of ported theme from https://github.com/ph-ph/chalk.git .
...
[params.social]
  ...
  github='example'
```
See [config file](https://github.com/ph-ph/chalk/blob/main/data/social/sites.toml) for a list of supported sites (there's plenty).
